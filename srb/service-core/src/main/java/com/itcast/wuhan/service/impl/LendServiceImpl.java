...
import com.itcast.wuhan.enums.LendStatusEnum;
import com.itcast.wuhan.enums.ReturnMethodEnum;
import com.itcast.wuhan.enums.TransTypeEnum;
import com.itcast.wuhan.exception.BusinessException;
...
import com.itcast.wuhan.mapper.LendMapper;
...
import com.itcast.wuhan.pojo.entity.*;
...
public class LendServiceImpl extends ServiceImpl<LendMapper, Lend> implements LendService {
    ...
    public void makeLoan(Long lendId) {
        ...
        lendItemList.stream().forEach(item -> {
            ...
            userAccountMapper.updateAccount(investBindCode, new BigDecimal(0), investAmount.negate()); //investAmount.negate()取负数
